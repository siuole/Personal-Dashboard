...
// Subtle tint per condition — sits on top of the dark glassmorphism base
function getTint(cat: WeatherCat): string {
  switch (cat) {
    case 'clear':  return 'rgba(255,195,30,0.06)';
    case 'rain':   return 'rgba(70,120,210,0.07)';
    case 'storm':  return 'rgba(70,70,95,0.09)';
    case 'snow':   return 'rgba(100,180,255,0.07)';
    case 'mist':   return 'rgba(150,160,175,0.07)';
    default:       return 'rgba(100,130,170,0.06)';
  }
}
  ...
  if (cat === 'rain') return (
    <svg width="76" height="76" viewBox="0 0 80 80" fill="none">
      ...
      <path d="M16 42a16 16 0 0 1 16-16h6a16 16 0 1 1 0 32H32A16 16 0 0 1 16 42Z"
        fill="rgba(100,140,200,0.25)" stroke="rgba(80,120,185,0.5)" strokeWidth="1.5"/>
      <line className="wld1" x1="24" y1="62" x2="20" y2="72" stroke="rgba(100,160,255,0.8)" strokeWidth="2.2" strokeLinecap="round"/>
      <line className="wld2" x1="36" y1="62" x2="32" y2="72" stroke="rgba(100,160,255,0.8)" strokeWidth="2.2" strokeLinecap="round"/>
      <line className="wld3" x1="48" y1="62" x2="44" y2="72" stroke="rgba(100,160,255,0.8)" strokeWidth="2.2" strokeLinecap="round"/>
      <line className="wld4" x1="60" y1="62" x2="56" y2="72" stroke="rgba(100,160,255,0.8)" strokeWidth="2.2" strokeLinecap="round"/>
    </svg>
  );
  ...
  if (cat === 'storm') return (
    <svg width="76" height="76" viewBox="0 0 80 80" fill="none">
      ...
      <path d="M14 40a16 16 0 0 1 16-16h6a16 16 0 1 1 0 32H30A16 16 0 0 1 14 40Z"
        fill="rgba(100,100,130,0.25)" stroke="rgba(120,120,160,0.4)" strokeWidth="1.5"/>
      <path className="wl-bolt" d="M44 56 L36 68 L42 68 L34 80 L52 62 L46 62 L54 50Z"
        fill="rgba(250,200,0,0.95)" />
    </svg>
  );
  ...
  if (cat === 'snow') return (
    <svg width="76" height="76" viewBox="0 0 80 80" fill="none">
      ...
      <path d="M16 40a16 16 0 0 1 16-16h6a16 16 0 1 1 0 32H32A16 16 0 0 1 16 40Z"
        fill="rgba(100,170,240,0.22)" stroke="rgba(130,180,255,0.45)" strokeWidth="1.5"/>
      {[24, 40, 56].map((x, i) => (
        <g key={i} className={`wls${i+1}`}>
          <line x1={x} y1="62" x2={x} y2="74" stroke="rgba(150,200,255,0.8)" strokeWidth="2" strokeLinecap="round"/>
          <line x1={x-6} y1="68" x2={x+6} y2="68" stroke="rgba(150,200,255,0.8)" strokeWidth="2" strokeLinecap="round"/>
        </g>
      ))}
    </svg>
  );
      ...
      <g className="wl-mist">
        {[22, 32, 42, 52].map((y, i) => (
          <line key={i} x1={10 + i * 2} y1={y} x2={70 - i * 2} y2={y}
            stroke={`rgba(180,190,210,${0.5 - i * 0.07})`} strokeWidth="3.5" strokeLinecap="round"/>
        ))}
      </g>
    </svg>
  );
    ...
    <svg width="76" height="76" viewBox="0 0 80 80" fill="none">
      ...
      <g className="wl-cloud">
        <path d="M12 48a18 18 0 0 1 18-18h8a18 18 0 1 1 0 36H30A18 18 0 0 1 12 48Z"
          fill="rgba(200,210,240,0.25)" stroke="rgba(180,190,220,0.4)" strokeWidth="1.5"/>
      </g>
    </svg>
  );
}
...
function SmallIcon({ cat }: { cat: WeatherCat }) {
    ...
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
      {[0,60,120,180,240,300].map((d, i) => (
        <line key={i} x1="12" y1="2" x2="12" y2="5"
          stroke="rgba(210,140,0,0.75)" strokeWidth="1.8" strokeLinecap="round"
  ...
  if (cat === 'rain') return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
      <path d="M5 16a8 8 0 1 1 14 0" fill="rgba(100,140,200,0.25)" stroke="rgba(100,160,255,0.5)" strokeWidth="1.3"/>
      <line x1="9" y1="19" x2="7" y2="23" stroke="rgba(100,160,255,0.8)" strokeWidth="1.5" strokeLinecap="round"/>
      <line x1="14" y1="19" x2="12" y2="23" stroke="rgba(100,160,255,0.8)" strokeWidth="1.5" strokeLinecap="round"/>
      <line x1="19" y1="19" x2="17" y2="23" stroke="rgba(100,160,255,0.8)" strokeWidth="1.5" strokeLinecap="round"/>
    </svg>
  );
  if (cat === 'storm') return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
      <path d="M4 14a7 7 0 1 1 12 0" fill="rgba(100,100,130,0.2)" stroke="rgba(120,120,160,0.45)" strokeWidth="1.3"/>
      <path d="M13 16 L10 20 L12 20 L9 24 L16 18 L14 18 L17 14Z" fill="rgba(250,200,0,0.9)"/>
    </svg>
  );
  if (cat === 'snow') return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
      <path d="M4 14a8 8 0 1 1 16 0" fill="rgba(100,170,240,0.22)" stroke="rgba(150,200,255,0.5)" strokeWidth="1.3"/>
      <line x1="9" y1="18" x2="9" y2="23" stroke="rgba(150,200,255,0.8)" strokeWidth="1.5" strokeLinecap="round"/>
      <line x1="15" y1="18" x2="15" y2="23" stroke="rgba(150,200,255,0.8)" strokeWidth="1.5" strokeLinecap="round"/>
    </svg>
  );
  if (cat === 'mist') return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
      {[7, 12, 17].map((y, i) => (
        <line key={i} x1={3 + i} y1={y} x2={21 - i} y2={y}
          stroke={`rgba(180,190,210,${0.55 - i * 0.1})`} strokeWidth="2" strokeLinecap="round"/>
      ))}
    </svg>
  );
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
      ...
      <path d="M4 16a6 6 0 0 1 6-6h3a6 6 0 1 1 0 12H10A6 6 0 0 1 4 16Z"
        fill="rgba(200,210,240,0.25)" stroke="rgba(180,190,220,0.45)" strokeWidth="1.2"/>
    </svg>
  );
}
...
function Stat({ icon, label }: { icon: React.ReactNode; label: string }) {
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
      {icon}
      <span style={{ fontSize: 11, fontWeight: 500, color: '#9CA3AF', letterSpacing: 0.1 }}>
        {label}
      </span>
    </div>
  );
...
function HumiditySvg() {
  return (
    <svg width="11" height="13" viewBox="0 0 24 24" fill="#6B7280" stroke="none">
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
          <div>
            <div style={{
              fontSize: 58, fontWeight: 700, color: '#F9FAFB',
