...
export default function GoalsWidget({ period }: { period: Period }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
        ...
        {goals.map((goal, idx) => (
          <div
            ...
            style={{
              ...
              padding: '8px 4px',
              borderBottom: idx < goals.length - 1 ? '1px solid rgba(255,255,255,0.06)' : 'none',
            }}
          >
            <button
              ...
              style={{
                ...
                border: goal.done ? 'none' : '1px solid rgba(255,255,255,0.15)',
                fontSize: '14px',
                background: goal.done ? '#6366F1' : 'rgba(255,255,255,0.07)',
                cursor: 'pointer',
                display: 'flex', alignItems: 'center', justifyContent: 'center',
                boxShadow: goal.done ? '0 0 10px rgba(99,102,241,0.5)' : 'none',
            ...
            <button
              ...
              style={{
                ...
                background: 'none', cursor: 'pointer', color: 'rgba(255,255,255,0.2)',
      ...
      {/* Add goal input */}
      <div style={{ display: 'flex', gap: 6, marginTop: 10, paddingTop: 10, borderTop: '1px solid rgba(255,255,255,0.07)' }}>
        <input
          ref={inputRef}
          value={inputVal}
        ...
        <button
          ...
          style={{
            ...
            color: inputVal.trim() ? '#F9FAFB' : 'rgba(255,255,255,0.2)',
            background: inputVal.trim() ? 'rgba(99,102,241,0.7)' : 'rgba(255,255,255,0.04)',
            border: '1px solid',
            borderColor: inputVal.trim() ? 'rgba(99,102,241,0.8)' : 'rgba(255,255,255,0.08)',
            borderRadius: '0.5em',
            cursor: inputVal.trim() ? 'pointer' : 'default',
            fontFamily: 'inherit',
            boxShadow: inputVal.trim() ? '0 0 12px rgba(99,102,241,0.3)' : 'none',
